...
export default function MainPage() {
  ...
  useEffect(() => {
    ...
    // container_scroll.current.scrollTop = 0;
  },[]);
  ...
  useEffect(() => {
    ...
    console.log(container_scroll.current.scrollTop);
  ...
  return (
    <MainContainer>
      <MainInputBarContainer>
        <Input placeholder='질문을 입력하세요' type='text' maxLength={50} ref={inputRef} onKeyPress={handleOnKeyPress}> 
        </Input>
      ...
      <InputHistoryContainer ref={container_scroll}>
        {inputHistory.map((item, index) => (
          ...
          <InputHistoryItem key={index}>{item}
